...
export default function Index({ auth, subClassifications }) {
    ...
    const handleCreate = (e) => {
        e.preventDefault();
        createForm.post(route('sub-classifications.store'), {
            onSuccess: () => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        editForm.put(route('sub-classifications.update', selectedItem.id), {
            onSuccess: () => setIsEditModalOpen(false),
        });
    };

    const handleDelete = () => {
        editForm.delete(route('sub-classifications.destroy', selectedItem.id), {
    ...
    return (
        <SupabaseLayout user={auth.user} header="Sub Kualifikasi">
            <Head title="Sub Kualifikasi" />

            <div className="flex flex-col space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-bold text-slate-900 tracking-tight">Master Sub Kualifikasi</h2>
                        <p className="text-sm text-slate-500 mt-1">Definisikan kategori sub kualifikasi untuk spesifikasi surat.</p>
                    </div>
                    <button 
            ...
            <SupabaseModal 
                ...
                title="Tambah Sub Kualifikasi Baru"
            >
                <form onSubmit={handleCreate} className="space-y-6">
                    ...
                    />
                    <SupabaseInput
                        label="Kode Sub Kualifikasi"
                        placeholder="Contoh: 00.1, KH, KT"
